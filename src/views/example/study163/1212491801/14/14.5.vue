...
import baseFragmentShader from './shader/14.5/fragment.glsl?raw';
import baseVertexShader from './shader/14.5/vertex.glsl?raw';
...
const textureParalympicGames = textureLoader.load('uv_paralympic_games.jpeg');
