...
//  物理世界的材质
const cannonMaterialSphere = new CANNON.Material('sphere');
//  物理世界的物体
const cannonBodySphere = new CANNON.Body({
    shape: cannonGeometrySphere,
...
cannonBodySphere.addEventListener('collide', eventSphereCollide);
...
const update = () => {
    ...
    meshSphere.position.copy(cannonBodySphere.position);
};
