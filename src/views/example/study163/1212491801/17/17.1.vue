...
import fragmentShader from './shader/lantern/fragment.glsl?raw';
import vertexShader from './shader/lantern/vertex.glsl?raw';
...
camera.position.set(5, -40, 160.2);
...
const createFireworks = () => {
    ...
    let firework = new Fireworks({
        ...
        sound: {
            send: '/static/example/study163/1212491801/sound/firework-send.mp3',
            bloom: '/static/example/study163/1212491801/sound/firework-bloom.mp3',
        }
    });
    fireworksCollection.push(firework);
};

window.addEventListener('click', createFireworks, false);

const update = () => {
    for (const element of fireworksCollection) {
        element.update();
    }
};
