...
/*  物理材质
══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════*/
let mapRoughnessBrick = textureLoader.load('brick/brick_roughness.jpg');
const materialSphere = new THREE.MeshPhysicalMaterial({
    ...
    //  光泽颜色
    sheenColor: 0xffffff,
    //  光泽颜色贴图 会与光泽颜色通道相乘, 白色系数度为1, 黑色系数度为0
    sheenColorMap: mapRoughnessBrick,
    //  光泽粗糙度
    sheenRoughness: 1,
    //  光泽粗糙度贴图 会与光泽粗糙度相乘
    sheenRoughnessMap: mapRoughnessBrick
});
